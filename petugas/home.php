...
<body>
  <!-- top navigation bar -->
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top shadow" style="background-color: #000080;">
  ...
  <!-- offcanvas -->
  <div class="offcanvas offcanvas-start sidebar-nav shadow" tabindex="-1" id="sidebar" style="background-color: #000080;">
    ...
    <div class="container-fluid">
      <div class="row ">
        <div class="col-md-12 mb-2 mt-2">
          <h4>Haii <?php echo $_SESSION['username']; ?>, Selamat Bertugas!!</h4>
        </div>
      </div>
