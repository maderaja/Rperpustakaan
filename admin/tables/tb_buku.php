              ...
              <table class="table table-bordered table-striped text-center mt-3">
                ...
                <?php foreach ($buku as $row) : ?>
                  ...
                  <tr>
                    <td><?= $i ?></td>
                    <td>
                      <a href="../ubah/ubah_buku.php?id=<?= $row["id_buku"]; ?>" class="btn btn-warning"><i class="bi bi-pencil-square"></i> ubah</a>
                      <a href="../hapus/hapus_buku.php?id=<?= $row["id_buku"]; ?>" onclick="return confirm('anda yakin akan menghapus data ini?');" class="btn btn-danger"><i class="bi bi-trash-fill"></i> hapus</a>
                    </td>
                    <td><img src="../../img/buku/<?= $row["cover"] ?>" width="70"></td>
                    <td><?= $row["judul"]; ?></td>
                    <td><?= $row["pengarang"]; ?></td>
                    <td><?= $row["penerbit"]; ?></td>
                    <td><?= $row["kode_buku"]; ?></td>
