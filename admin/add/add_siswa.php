            ...
            <div class="card-body">
              <form action="" method="POST" enctype="multipart/form-data">
                <div class="form-group mb-3">
                  ...
                  <input type="text" name="name" id="name" required autocomplete="off" class="form-control" placeholder="Input Nama Siswa">
                ...
                <div class="form-group mb-3">
                  ...
                  <input type="text" name="username" id="username" required autocomplete="off" class="form-control" placeholder="Input Username Siswa">
                ...
                <div class="form-group mb-3">
                  ...
                  <input type="password" name="password" id="password" required autocomplete="off" class="form-control" placeholder="Input password Siswa">
