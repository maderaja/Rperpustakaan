            ...
            <div class="card-body">
              <form action="" method="POST" enctype="multipart/form-data">
                <div class="form-group mb-3">
                  ...
                  <input type="text" name="judul" id="judul" required autocomplete="off" class="form-control" placeholder="Judul Buku">
                ...
                <div class="form-group mb-3">
                  ...
                  <input type="text" name="pengarang" id="pengarang" required autocomplete="off" class="form-control" placeholder="Pengarang Buku">
                ...
                <div class="form-group mb-3">
                  ...
                  <input type="text" name="penerbit" id="penerbit" required autocomplete="off" class="form-control" placeholder="Penerbit Buku">
                ...
                <div class="form-group mb-3">
                  ...
                  <input type="text" name="kode_buku" id="kode_buku" required autocomplete="off" class="form-control" placeholder="Kode Buku">
                ...
                <div class="form-group mb-3">
                  ...
                  <input type="text" name="jumlah_buku" id="jumlah_buku" required autocomplete="off" class="form-control" placeholder="Jumlah Buku">
                ...
                <div class="form-group mb-3">
                  <label for="cover">
                    Cover :
                    <input type="file" name="cover" id="cover" autocomplete="off" class="form-control">
                  </label>
                </div>
