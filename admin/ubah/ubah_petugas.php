...
//query data petugas berdasarkan id nya
$ptgs = query("SELECT * FROM tb_petugas WHERE id_petugas = $id")[0];
            ...
            <div class="card mt-3 shadow">
              ...
              <div class="card-body">
                <form action="" method="POST" enctype="multipart/form-data">
                  ...
                  <input type="hidden" name="fotoLama" value="<?= $ptgs["foto"]; ?>">

                  <div class="form-group mb-3">
                    <label for="nama">
                      Nama :
                    </label>
                    <input type="text" name="nama" id="nama" required value="<?= $ptgs["nama"]; ?>" autocomplete="off" class="form-control">
                  ...
                  <div class="form-group mb-3">
                    ...
                    <input type="text" name="username" id="username" required value="<?= $ptgs["username"]; ?>" autocomplete="off" class="form-control">
                  </div>
                  ...
                  <div class="form-group mb-3">
                    ...
                    <input type="email" name="email" id="email" required value="<?= $ptgs["email"]; ?>" autocomplete="off" class="form-control">
                  </div>

                  <div class="form-group mb-3">
                    <label for="foto">
                      Foto : <br>
                      <img src="../../img/petugas/<?= $ptgs['foto']; ?>" width="70"> <br>
